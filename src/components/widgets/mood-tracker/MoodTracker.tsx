...
export default function MoodTracker() {
    ...
    return (
        ...
        <div className="w-full border-t border-border sm:col-span-1 flex flex-col p-5 rounded-3xl bg-background/50 app-blur min-h-60 max-h-60 gap-y-3 lg:row-span-1">
            <Header />
