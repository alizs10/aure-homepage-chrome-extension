...
function NotesAndChecklistsContent() {
    return (
        <div className="relative sm:col-span-1 app_container app_shadow app_gradient app-blur flex flex-col gap-y-4 p-5 min-h-110 max-h-110 lg:max-h-124 lg:row-span-2">
