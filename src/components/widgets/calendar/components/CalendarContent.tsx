...
export default function CalendarContent() {
    ...
    return (
        <div className="w-full sm:col-span-1 rounded-3xl app_shadow app_gradient app-blur h-full min-h-110 max-h-110 lg:max-h-124 flex flex-col gap-y-4 p-5 lg:row-span-2">
