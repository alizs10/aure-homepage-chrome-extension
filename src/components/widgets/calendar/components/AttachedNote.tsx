            ...
            <div className="rounded-3xl app_shadow bg-background px-4 py-2 group relative">
                {attachedNote ? (
                    <>
                        ...
                        <div className="absolute inset-0 left-auto transition-colors duration-200 w-0 group-hover:w-24 h-full flex-center gap-2 overflow-clip border-t-0!  app-blur rounded-l-none! z-20">
                            <Button
                                onClick={toggle}
