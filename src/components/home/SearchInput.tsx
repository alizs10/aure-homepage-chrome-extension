...
export default function SearchInput() {
    ...
    return (
        <div className="w-full flex flex-nowrap px-4 md:px-8 lg:px-10 h-12 md:h-14 lg:h-16 relative">
            ...
            >
                <TextInput
                    className={`flex-1 mt-auto text-sm sm:text-lg md:text-xl lg:text-2xl sm:px-6 md:py-2.5 lg:px-10 lg:py-4 h-full ${isCommandMode ? 'border-accent ring-1 ring-accent/20' : ''
                        }`}
