    ...
    return (
        <header className="flex justify-between h-10 md:h-12 lg:h-14 px-4 md:px-8 lg:px-10">
            ...
            <div className="flex-row-center gap-x-2">
                ...
                <div className="hidden sm:flex rounded-3xl app_shadow app_gradient app-blur h-10 md:h-full px-4 md:px-6 lg:px-12 w-fit flex-center">
            ...
            <div className="flex-row-center gap-x-0.5 sm:gap-x-1.5 md:gap-x-2">
                ...
                <div className="h-full rounded-3xl app_shadow app_gradient app-blur w-14 sm:w-32 md:w-36 lg:w-48 flex-center">
